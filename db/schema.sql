-- 1. Garante a criação do Schema sem estourar erro
CREATE SCHEMA IF NOT EXISTS synapse AUTHORIZATION postgres;
...
-- Nota: O PostgreSQL não aceita "IF NOT EXISTS" nativo para CREATE INDEX em versões antigas, 
-- mas nas versões recentes (PostgreSQL 9.5+) funciona perfeitamente.
...
-- ==========================================
-- 8. TABELA: document_jobs (Sua Feature do Textract!)
-- ==========================================
